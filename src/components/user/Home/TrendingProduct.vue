      ...
      <section class="related-product">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" v-for="TrendingProduct in TrendingProducts" :key="TrendingProduct.id">
                        ...
                        <div class="product__item__pic set-bg d-flex justify-content-center" >
                          <img :src="`http://localhost:8000/`+ TrendingProduct.image" alt="TrendingProduct.name" /> 
                            <ul class="product__item__pic__hover">
                                <li><a  @click="addToWishList(TrendingProduct.id)" ><i class="fa fa-heart"></i></a></li>
                                <li><router-link :to="'/productDetails/'+TrendingProduct.id" >  <i class="fas fa-eye"></i> </router-link></li>
                                <li><a @click="addToCart(TrendingProduct.id)" ><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            <h6>{{ TrendingProduct.name }}</h6>
                            <h5>{{ TrendingProduct.price }}</h5>
                        </div>
                    </div>
                </div>
