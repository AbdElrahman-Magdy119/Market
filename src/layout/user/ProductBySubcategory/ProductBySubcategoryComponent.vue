                        ...
                        <div class="product__item__pic set-bg d-flex justify-content-center" >
                          <img :src="`http://localhost:8000/`+ product.image" alt="product.name" /> 
                            <ul class="product__item__pic__hover">
                                ...
                                <li><router-link :to="'/productDetails/'+product.id" >  <i class="fas fa-eye"></i> </router-link></li>
...
export default {
  ...
  mounted() {
    let cateId = this.$route.params.idSubCategory
    HomeService.getProductBySubcategory(cateId).then((data) => {
