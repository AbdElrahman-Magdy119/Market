        ...
        <div class="col-lg-12">
          <div class="shoping__cart__table">
            <table>
              ...
              <tbody>
                <tr
                  v-for="WishList_item in UserWishList"
                ...
                >
                  <td class="shoping__cart__item">
                    <img
                      :src="
                        `http://localhost:8000/` +
                        WishList_item.product_id.image
                      "
                      :alt="WishList_item.product_id.name"
                    />
                    <h5>{{ WishList_item.product_id.name }}</h5>
                  </td>
                  <td class="shoping__cart__total">
                    <Badge
                      v-if="Availability(WishList_item.product_id.quantity)"
                      severity="success"
                      size="xlarge"
                    >
                      In Stock
                  ...
                  <td class="shoping__cart__price">
                    <h5>{{ WishList_item.product_id.price }}</h5>
                  </td>
                  <td class="shoping__cart__price">
                  ...
                  <td class="shoping__cart__item__close">
                    <span class="icon_close"
                      ><i
                        ...
                        @click="deleteProductFromWishList(WishList_item.id)"
                      ></i
                    ></span>
                  </td>
                </tr>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="shoping__cart__btns">
            <router-link :to="'/shop'" class="primary-btn cart-btn">
...
export default {
  ...
  mounted() {
    WishListService.getWishlist().then((data) => {
      this.UserWishList = data.data.data;
      ...
      WishListService.deleteProduct(id)
        ...
        .catch((error) => {
          ...
          this.$toast.add({
            severity: "error",
            summary: "Error",
            detail: "Failed to Product category",
            life: 3000,
          });
        });
    },
