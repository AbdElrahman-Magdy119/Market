            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                  <h3>{{ product.name }}</h3>
                  <div
                    class="product__details__rating d-flex justify-content-start"
                  >
                    <Rating
                      v-model="averageRating"
                      :cancel="false"
                      :pt="{
                        onIcon: { class: 'text-warning' },
                      }"
                      :readonly="true"
                    />
                    <span>({{ this.allReviews.count }} reviews)</span>
                  </div>
                  <div class="product__details__price">{{ product.price }}</div>
                  <p>
                   {{ product.description }}
                  </p>
                  <a @click="addToCart(product.id)" class="primary-btn">ADD TO CARD</a>
                  <a
				    @click="addToWishList(product.id)"
                    class="heart-icon"
                    style="padding: 10px 18px 14px; font-size: 20px"
                    ><div class="fas fa-heart fs-1"></div
                  ></a>
                  <ul>
                    <li><b>Availability</b> <span> <Badge
                      v-if="Availability(product.quantity)"
                      severity="success"
                      size="xlarge"
                    >
                      In Stock
        ...
        <section class="related-product">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6" v-for="relatedProduct in relatedProducts" :key="relatedProduct.id">
                <div class="product__item">
                  <div class="product__item__pic set-bg">
                    <img :src="`http://localhost:8000/`+ relatedProduct.image" />
                    <ul class="product__item__pic__hover">
						<li><a  @click="addToWishList(relatedProduct.id)" ><i class="fa fa-heart"></i></a></li>
						<li><a @click="addToCart(relatedProduct.id)" ><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                  </div>
